...
<?php
          ...
          if ($_SESSION['login_user']) 
          {?>
<center><h1 style="margin-top: -50px"><b>Do Report if Someone Is <font color="red">Missing</font></b></h1></center>
<br><br>
<h1><center><b>Report Someone</b></center></h1>

			
	
  <div class="column" style = "margin-left: 10px; width: 100%;" >
    <h2 style="border-bottom: thin solid; "><center><b><font size="6">Fill Up</font></b></center></h2>
   <?php 
...
$info = "SELECT * FROM product WHERE Category='Extra'";
...
<div>
		<table width="100%">
			...
			<tr style="background-color: whitesmoke;"> 
				...
				<tr style="background-color: transparent;"><td><input type="submit" style="width:100%" name="add" class="btn btn-success" value="Add To Cart" style="font-size: 16px;"></td></tr>
...
<?php }else{ ?> <br><br><?php 
	echo "<b><center>Log In First before you Report</center></b>";
} ?>
</body>
</html>